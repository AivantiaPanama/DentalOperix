...
import type { PatientLookupPort, PatientLookupResult } from "../application/ports/patient-lookup-port";
...
export class PatientLookupAdapter implements PatientLookupPort {
  constructor(private readonly patientPersistencePort: PatientPersistencePort = createPatientPersistencePort()) {}
...
export function createPatientLookupPort(patientPersistencePort?: PatientPersistencePort): PatientLookupPort {
