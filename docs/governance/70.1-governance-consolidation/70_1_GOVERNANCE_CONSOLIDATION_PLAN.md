...
1. Consolidate documentation under DGF v1.0.
2. Establish GMI as governance authority.
3. Register official documents.
4. Register certifications.
5. Document baseline transition from 57.9 to 69.2.
6. Validate cross references.
7. Prepare GML-1 certification evidence.
