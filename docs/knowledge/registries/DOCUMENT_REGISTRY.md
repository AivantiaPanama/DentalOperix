# DentalOperix Document Registry

## Status

CONTROLLED RECORD / ACTIVE

| ID                 | Document                                                                                                                                       | Classification    | Status              | Baseline |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | ------------------- | -------- |
| GMI-70.0           | docs/governance/70.0-governance-pack/GOVERNANCE_MASTER_INDEX.md                                                                                | Normative         | Approved            | 69.2     |
| DGF-70.0           | docs/governance/70.0-governance-pack/DENTALOPERIX_GOVERNANCE_FRAMEWORK_V1.md                                                                   | Normative         | Approved            | 69.2     |
| GMM-GML1           | docs/governance/70.0-governance-pack/GOVERNANCE_MATURITY_MODEL_GML1.md                                                                         | Normative         | Approved            | 69.2     |
| GDR-001            | docs/governance/70.0-governance-pack/GDR-001_GOVERNANCE_MASTER_INDEX_ADOPTION.md                                                               | Controlled Record | Approved            | 69.2     |
| PLAN-70.1          | docs/governance/70.1-governance-consolidation/70_1_GOVERNANCE_CONSOLIDATION_PLAN.md                                                            | Planning          | Approved            | 69.2     |
| REP-70.1-CRV       | docs/audits/70.1/70_1_CROSS_REFERENCE_VALIDATION_REPORT.md                                                                                     | Evidence          | Completed           | 69.2     |
| CERT-70.1          | docs/governance/70.1-governance-consolidation/70_1_GOVERNANCE_CONSOLIDATION_CLOSURE_REPORT.md                                                  | Certification     | Closed / Certified  | 69.2     |
| SPEC-71.2          | docs/implementation/71.0-patients-functional-development/71.2-functional-specification/DENTALOPERIX_71_2_PATIENTS_FUNCTIONAL_SPECIFICATION.md  | Evidence          | Closed / Certified  | 69.2     |
| REP-71.3-ARCH      | docs/implementation/71.0-patients-functional-development/71.3-architecture-validation/DENTALOPERIX_71_3_ARCHITECTURE_VALIDATION_REPORT.md      | Evidence          | Passed              | 69.2     |
| REG-71.3-DOMAIN    | docs/implementation/71.0-patients-functional-development/71.3-architecture-validation/DENTALOPERIX_71_3_DOMAIN_COMPLIANCE_MATRIX.md            | Controlled Record | Passed              | 69.2     |
| REG-71.3-TRACE     | docs/implementation/71.0-patients-functional-development/71.3-architecture-validation/DENTALOPERIX_71_3_USE_CASE_TRACEABILITY_MATRIX.md        | Controlled Record | Passed              | 69.2     |
