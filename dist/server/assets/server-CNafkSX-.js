...
import { c as runWithStartContext, d as FrameType, f as TSS_CONTENT_TYPE_FRAMED_VERSIONED, g as X_TSS_SERIALIZED, h as X_TSS_RAW_RESPONSE, i as csrfSymbol, l as createNullProtoObject, m as TSS_SERVER_FUNCTION, n as getDefaultSerovalPlugins, o as flattenMiddlewares, p as TSS_FORMDATA_CONTEXT, r as createCsrfMiddleware, s as getStartContext, t as mergeHeaders, u as safeObjectMerge } from "./esm-vQsjfqSA.js";
import "react";
...
import { createRawStreamRPCPlugin, createSerializationAdapter, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, isNotFound, isRedirect, isResolvedRedirect, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DLjLr3LG.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-NKfx16Qy.js"),
		import("./start-hIvhvt3_.js"),
